...
from Champu.modules.helpers import PNG_BTN


@ChampuBot.on_cmd("ping")
async def ping(_, message: Message):
    ...
    await loda.edit_text(
        text=f"нey вαву!!\n{ChampuBot.name} ιѕ alιve 🥀 αnd worĸιng ғιne wιтн a pιng oғ\n➥ `{ms}` ms\n\n<b>|| мαdє ωιтн ❣️ ву [ʏᴏɢᴇsʜ](https://t.me/{OWNER_USERNAME}) ||</b>",
